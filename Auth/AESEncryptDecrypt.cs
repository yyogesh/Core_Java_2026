    ...
    public class AESEncryptDecrypt
    {
        ...
        public static string DecryptStringAES(string cipherText)
        {
            ...
            try
            {
                ...
                // Check if decryption returned "keyError" which indicates decryption failure (case-insensitive comparison)
                if (string.Compare(decriptedFromJavascript, "keyError", StringComparison.OrdinalIgnoreCase) == 0)
                {
                    return string.Empty;
                }
